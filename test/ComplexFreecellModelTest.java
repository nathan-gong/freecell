...
/**
 * Test class for the ComplexFreecellModel class.
 */
public class ComplexFreecellModelTest {
  ...
  @Before
  public void init() {
    this.m1 = new ComplexFreecellModel();
    this.m2 = FreecellModelCreator.create(GameType.MULTIMOVE);
  ...
  public void testMove25() {
    ...
    this.m1.move(PileType.CASCADE, 0, 12, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 0, 11, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 0, 10, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 1, 10, PileType.CASCADE, 0);
  }

  // test that a build cannot be moved if it does not have values decreasing by one
  @Test(expected = IllegalArgumentException.class)
  public void testMove26() {
    this.m1.startGame(this.m1.getDeck(), 4, 2, false);
    this.m1.move(PileType.CASCADE, 3, 11, PileType.CASCADE, 0);
  }

  // test that a build cannot be moved if it does not form a build with the destination cascade pile
  @Test(expected = IllegalArgumentException.class)
  public void testMove27() {
    this.m1.startGame(this.m1.getDeck(), 4, 2, false);
    this.m1.move(PileType.CASCADE, 3, 11, PileType.CASCADE, 1);
  }

  // test that a valid build cannot be moved to an empty open pile
  @Test(expected = IllegalArgumentException.class)
  public void testMove28() {
    this.m1.startGame(this.l1, 4, 2, false);
    this.m1.move(PileType.CASCADE, 0, 12, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 0, 11, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 1, 12, PileType.FOUNDATION, 1);
    this.m1.move(PileType.CASCADE, 1, 11, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 2, 12, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 0, 10, PileType.OPEN, 0);
  }

  // test that an invalid build cannot be moved to an empty open pile
  @Test(expected = IllegalArgumentException.class)
  public void testMove29() {
    this.m1.startGame(this.m1.getDeck(), 4, 2, false);
    this.m1.move(PileType.CASCADE, 3, 11, PileType.OPEN, 0);
  }

  // test that a valid build cannot be moved to a full open pile
  @Test(expected = IllegalArgumentException.class)
  public void testMove30() {
    this.m1.startGame(this.l1, 4, 2, false);
    this.m1.move(PileType.CASCADE, 0, 12, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 0, 11, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 1, 12, PileType.FOUNDATION, 1);
  ...
  public void testMove32() {
    ...
    this.m1.move(PileType.CASCADE, 1, 11, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 2, 12, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 0, 10, PileType.FOUNDATION, 3);
  }
  ...
  public void testMove33() {
    this.m1.startGame(this.m1.getDeck(), 4, 2, false);
    this.m1.move(PileType.CASCADE, 3, 11, PileType.FOUNDATION, 0);
  }

  // test that a valid build cannot be moved to an occupied foundation pile
  @Test(expected = IllegalArgumentException.class)
  public void testMove34() {
    this.m1.startGame(this.l1, 4, 2, false);
    this.m1.move(PileType.CASCADE, 0, 12, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 0, 11, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 1, 12, PileType.FOUNDATION, 1);
    this.m1.move(PileType.CASCADE, 1, 11, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 2, 12, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 3, 12, PileType.FOUNDATION, 3);
    this.m1.move(PileType.CASCADE, 0, 10, PileType.FOUNDATION, 3);
  }

  // test that an invalid build cannot be moved to an occupied foundation pile
  @Test(expected = IllegalArgumentException.class)
  public void testMove35() {
    this.m1.startGame(this.l1, 4, 2, false);
    this.m1.move(PileType.CASCADE, 0, 12, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 3, 11, PileType.FOUNDATION, 0);
  }
  ...
  @Test
  public void testMove36() {
    this.m1.startGame(this.l1, 4, 2, false);
    for (int i = 12; i >= 0; i--) {
      this.m1.move(PileType.CASCADE, 3, i, PileType.FOUNDATION, 3);
    }
    this.m1.move(PileType.CASCADE, 0, 12, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 0, 11, PileType.FOUNDATION, 0);
    this.m1.move(PileType.CASCADE, 1, 12, PileType.FOUNDATION, 1);
    this.m1.move(PileType.CASCADE, 1, 11, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 2, 12, PileType.CASCADE, 0);
    assertEquals(this.c41, this.m1.getCascadeCardAt(0, 10));
    assertEquals(this.c46, this.m1.getCascadeCardAt(0, 11));
    assertEquals(this.c51, this.m1.getCascadeCardAt(0, 12));
    this.m1.move(PileType.CASCADE, 0, 10, PileType.CASCADE, 3);
    assertEquals(this.c41, this.m1.getCascadeCardAt(3, 0));
    assertEquals(this.c46, this.m1.getCascadeCardAt(3, 1));
    assertEquals(this.c51, this.m1.getCascadeCardAt(3, 2));
    this.m1.move(PileType.CASCADE, 3, 0, PileType.CASCADE, 3);
    assertEquals(this.c41, this.m1.getCascadeCardAt(3, 0));
    assertEquals(this.c46, this.m1.getCascadeCardAt(3, 1));
    assertEquals(this.c51, this.m1.getCascadeCardAt(3, 2));
  }
  ...
  public void testMove39() {
    ...
    this.m1.move(PileType.CASCADE, 1, 11, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 2, 12, PileType.CASCADE, 0);
    this.m1.move(PileType.CASCADE, 2, 11, PileType.CASCADE, 1);
    this.m1.move(PileType.CASCADE, 2, 10, PileType.OPEN, 0);
    assertEquals(this.c42, this.m1.getCascadeCardAt(1, 10));
    assertEquals(this.c47, this.m1.getCascadeCardAt(1, 11));
    this.m1.move(PileType.CASCADE, 1, 10, PileType.CASCADE, 2);
    assertEquals(this.c42, this.m1.getCascadeCardAt(2, 10));
    assertEquals(this.c47, this.m1.getCascadeCardAt(2, 11));
  }

  // test that a valid build can only be moved if there are enough open intermediate slots
  @Test
  public void testMove40() {
    this.m1.startGame(this.l1, 4, 2, false);
    for (int i = 12; i >= 0; i--) {
      this.m1.move(PileType.CASCADE, 3, i, PileType.FOUNDATION, 3);
    }
  ...
  public void testMove41() {
    ...
    assertEquals(this.c46, this.m1.getCascadeCardAt(0, 11));
    assertEquals(this.c51, this.m1.getCascadeCardAt(0, 12));
    this.m1.move(PileType.CASCADE, 2, 11, PileType.OPEN, 0);
    this.m1.move(PileType.CASCADE, 0, 10, PileType.CASCADE, 3);
  }

  // test that any card can move to an empty cascade pile
  @Test
  public void testMove42() {
    this.m1.startGame(this.l1, 4, 2, false);
    for (int i = 12; i >= 0; i--) {
      this.m1.move(PileType.CASCADE, 3, i, PileType.FOUNDATION, 3);
    }
  ...
  public void testToString1() {
    this.m2.startGame(this.m2.getDeck(), 8, 4, false);
